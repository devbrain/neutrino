...
namespace formats::explode::mz
{
    struct register_
    {
        ...
        {
            return neutrino::utils::byte_order::from_little_endian(data.eax);
        }

        operator uint16_t() const
        {
            return neutrino::utils::byte_order::from_little_endian(data.r32.r16.ax);
        }
    ...
    public:
        ...
        uint16_t word()
        {
            uint16_t x;
            m_input.read(x);
            return neutrino::utils::byte_order::from_little_endian(x);
        }
        io::offset_type tell()
        {
            return m_input.tell();
