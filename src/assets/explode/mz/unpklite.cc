...
namespace formats::explode::mz
{
    bool unpklite::accept(input_exe_file& inp)
    {
        ...
        u.words[0] = neutrino::utils::byte_order::from_little_endian(u.words[0]);
        u.words[1] = neutrino::utils::byte_order::from_little_endian(u.words[1]);
              ...
              m_h_pklite_info(0)
    {
        ...
        m_h_pklite_info = neutrino::utils::byte_order::from_little_endian(m_h_pklite_info);
    ...
    void unpklite::unpack(output_exe_file& oexe)
    {
        ...
        uint16_t temp_extra = neutrino::utils::byte_order::to_little_endian(m_h_pklite_info);
