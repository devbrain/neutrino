...
{
    template <typename T>
    T generic_read(neutrino::utils::io::binary_reader& is, std::size_t size)
    {
        T e;
        std::size_t sz = 0;
    ...
    {
        neutrino::utils::io::binary_reader reader(is, neutrino::utils::io::binary_reader::BIG_ENDIAN_BYTE_ORDER);
