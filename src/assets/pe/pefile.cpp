...
namespace pefile
{
	...
	// ===========================================================================
	static void assign(PE_OPTIONAL_HEADER& opt, const OPTIONAL_HEADER_32* x)
	{
		opt.Is64Bit = false;
	...
	static void assign(PE_OPTIONAL_HEADER& opt, const OPTIONAL_HEADER_64* x)
	{
		opt.Is64Bit = true;
...
;\
	...
	BEGIN_FLAG_TRAITS(PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS) {
		PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_RESERVED1,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_RESERVED2,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_RESERVED3,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_RESERVED4,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_HIGH_ENTROPY_VA,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_DYNAMIC_BASE,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_FORCE_INTEGRITY,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_NX_COMPAT,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_NO_ISOLATION,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_NO_SEH,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_NO_BIND,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_APPCONTAINER,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_WDM_DRIVER,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_GUARD_CF,
			PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_TERMINAL_SERVER_AWARE
	} END_FLAG_TRAITS;

	BEGIN_FLAG_TRAITS(PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM) {
		PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_UNKNOWN,
			PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_NATIVE,
			PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_WINDOWS_GUI,
			PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_WINDOWS_CUI,
			PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_POSIX_CUI,
			PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_WINDOWS_CE_GUI,
			PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_EFI_APPLICATION,
			PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_EFI_BOOT_SERVICE_DRIVER,
			PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_EFI_RUNTIME_DRIVER,
			PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_EFI_ROM,
			PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_XBOX
	} END_FLAG_TRAITS;
	...
	std::size_t file_c::overlay_offset() const
	{
		...
		const PE_OPTIONAL_HEADER& opt = optional_header();
		std::size_t offset = 0;
		if (table.empty())
		{
			offset = file_size();
	...
	void file_c::_check_optional_header(abstract_reporter_c& reporter)
	{
		...
		if (!check_in_flags <PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM>(m_optional_header.Subsystem))
		{
			reporter.unknown_flag_set(abstract_reporter_c::OPTIONAL_HEADER_SUBSYSTEM, m_optional_header.Subsystem);
		}
		if (!check_in_flags <PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS>(m_optional_header.DllCharacteristics))
		{
	...
	// --------------------------------------------------------------------------------
	void file_c::_load_sections(bsw::istream_wrapper_c& stream, [[maybe_unused]] abstract_reporter_c& reporter)
	{
	...
	// --------------------------------------------------------------------------------
	const PE_OPTIONAL_HEADER& file_c::optional_header() const
	{
	...
	std::ostream& operator << (std::ostream& os, PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM v)
	{
		switch (v)
		{
		case PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_UNKNOWN: os << "PE_IMAGE_SUBSYSTEM_UNKNOWN"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_NATIVE: os << "PE_IMAGE_SUBSYSTEM_NATIVE"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_WINDOWS_GUI: os << "PE_IMAGE_SUBSYSTEM_WINDOWS_GUI"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_WINDOWS_CUI: os << "PE_IMAGE_SUBSYSTEM_WINDOWS_CUI"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_POSIX_CUI: os << "PE_IMAGE_SUBSYSTEM_POSIX_CUI"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_WINDOWS_CE_GUI: os << "PE_IMAGE_SUBSYSTEM_WINDOWS_CE_GUI"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_EFI_APPLICATION: os << "PE_IMAGE_SUBSYSTEM_EFI_APPLICATION"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_EFI_BOOT_SERVICE_DRIVER: os << "PE_IMAGE_SUBSYSTEM_EFI_BOOT_SERVICE_DRIVER"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_EFI_RUNTIME_DRIVER: os << "PE_IMAGE_SUBSYSTEM_EFI_RUNTIME_DRIVER"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM_EFI_ROM: os << "PE_IMAGE_SUBSYSTEM_EFI_ROM"; break;
		default: os << "--- UNKNOWN ---";
		}
		return os;
	}
	...
	std::ostream& operator << (std::ostream& os, PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS v)
	{
		switch (v)
		{
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_RESERVED1: os << "PE_IMAGE_DLLCHARACTERISTICS_RESERVED1"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_RESERVED2: os << "PE_IMAGE_DLLCHARACTERISTICS_RESERVED2"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_RESERVED3: os << "PE_IMAGE_DLLCHARACTERISTICS_RESERVED3"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_RESERVED4: os << "PE_IMAGE_DLLCHARACTERISTICS_RESERVED4"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_HIGH_ENTROPY_VA: os << "PE_IMAGE_DLLCHARACTERISTICS_HIGH_ENTROPY_VA"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_DYNAMIC_BASE: os << "PE_IMAGE_DLLCHARACTERISTICS_DYNAMIC_BASE"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_FORCE_INTEGRITY: os << "PE_IMAGE_DLLCHARACTERISTICS_FORCE_INTEGRITY"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_NX_COMPAT: os << "PE_IMAGE_DLLCHARACTERISTICS_NX_COMPAT"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_NO_ISOLATION: os << "PE_IMAGE_DLLCHARACTERISTICS_NO_ISOLATION"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_NO_SEH: os << "PE_IMAGE_DLLCHARACTERISTICS_NO_SEH"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_NO_BIND: os << "PE_IMAGE_DLLCHARACTERISTICS_NO_BIND"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_APPCONTAINER: os << "PE_IMAGE_DLLCHARACTERISTICS_APPCONTAINER"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_WDM_DRIVER: os << "PE_IMAGE_DLLCHARACTERISTICS_WDM_DRIVER"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_GUARD_CF: os << "PE_IMAGE_DLLCHARACTERISTICS_GUARD_CF"; break;
		case PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS_TERMINAL_SERVER_AWARE: os << "PE_IMAGE_DLLCHARACTERISTICS_TERMINAL_SERVER_AWARE"; break;
		default: os << "--- UNKNOWN ---";
		}
		return os;
	}
	...
	std::ostream& operator << (std::ostream& os, const PE_OPTIONAL_HEADER& v)
	{
		...
		os << "Subsystem =                   " << static_cast <PE_OPTIONAL_HEADER::PE_IMAGE_SUBSYSTEM>(v.Subsystem) << std::endl;
		os << "DllCharacteristics =          " << flags <PE_OPTIONAL_HEADER::PE_IMAGE_DLLCHARACTERISTICS>(v.DllCharacteristics) << std::endl;
