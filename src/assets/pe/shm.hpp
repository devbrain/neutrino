#ifndef __BSW_SHM_HPP__
#define __BSW_SHM_HPP__
...
namespace bsw
{
	...
	public:
		...
		shared_memory_c(const char* name, unsigned int size, bool is_global);
		shared_memory_c(const char* name, bool is_global);
		...
		static bool can_create_global();
		static bool can_create_global(void* token);
	private:
