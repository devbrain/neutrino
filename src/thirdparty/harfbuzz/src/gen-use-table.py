...
print(" *")
print(
    " *   {} IndicSyllabicCategory.txt IndicPositionalCategory.txt UnicodeData.txt ArabicShaping.txt Blocks.txt IndicSyllabicCategory-Additional.txt IndicPositionalCategory-Additional.txt".format(
        sys.argv[0]))
print(" *")
...
for p in sorted(pages):
    ...
    for (start, end) in zip(starts, ends):
        ...
        print("      if (hb_in_range<hb_codepoint_t> (u, 0x%04Xu, 0x%04Xu)) return use_table[u - 0x%04Xu + %s];" % (
