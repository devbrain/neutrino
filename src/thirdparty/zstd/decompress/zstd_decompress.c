 ...
 */
static size_t
ZSTD_DDictHashSet_addDDict (ZSTD_DDictHashSet *hashSet, const ZSTD_DDict *ddict, ZSTD_customMem customMem) {
...
size_t ZSTD_decompressContinue (ZSTD_DCtx *dctx, void *dst, size_t dstCapacity, const void *src, size_t srcSize) {
  ...
  switch (dctx->stage) {
    ...
    case ZSTDds_decompressBlock: DEBUGLOG(5, "ZSTD_decompressContinue: case ZSTDds_decompressBlock");
      {
        ...
        RETURN_ERROR_IF(
            rSize > dctx->fParams.blockSizeMax, corruption_detected, "Decompressed Block Size Exceeds Maximum");
    ...
    case ZSTDds_decodeSkippableHeader:
      ...
      ZSTD_memcpy(
          dctx->headerBuffer + (ZSTD_SKIPPABLEHEADERSIZE - srcSize), src, srcSize);   /* complete skippable header */
...
size_t ZSTD_DCtx_setParameter (ZSTD_DCtx *dctx, ZSTD_dParameter dParam, int value) {
  ...
  switch (dParam) {
    ...
    case ZSTD_d_format: CHECK_DBOUNDS(ZSTD_d_format, value);
      ...
      return 0;
    case ZSTD_d_stableOutBuffer: CHECK_DBOUNDS(ZSTD_d_stableOutBuffer, value);
      dctx->outBufferMode = (ZSTD_bufferMode_e) value;
      return 0;
    case ZSTD_d_forceIgnoreChecksum: CHECK_DBOUNDS(ZSTD_d_forceIgnoreChecksum, value);
      dctx->forceIgnoreChecksum = (ZSTD_forceIgnoreChecksum_e) value;
      return 0;
    case ZSTD_d_refMultipleDDicts: CHECK_DBOUNDS(ZSTD_d_refMultipleDDicts, value);
      ...
      case zdss_loadHeader : DEBUGLOG(5, "stage zdss_loadHeader (srcSize : %u)", (U32) (iend - ip));
        ...
        if (zds->fParams.frameContentSize != ZSTD_CONTENTSIZE_UNKNOWN
          ...
          if (cSize <= (size_t) (iend - istart)) {
            ...
            size_t const decompressedSize = ZSTD_decompress_usingDDict (zds, op, (size_t) (oend
                                                                                           - op), istart, cSize, ZSTD_getDDict (zds));
