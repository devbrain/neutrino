...
namespace neutrino::kernel::tmx {
  cell cell::decode_gid (unsigned int gid) {
    ...
    // Read out the flags
    bool hflip = (gid & FLIPPED_HORIZONTALLY_FLAG) == FLIPPED_HORIZONTALLY_FLAG;
    bool vflip = (gid & FLIPPED_VERTICALLY_FLAG)   == FLIPPED_VERTICALLY_FLAG;
    bool dflip = (gid & FLIPPED_DIAGONALLY_FLAG)   == FLIPPED_DIAGONALLY_FLAG;
