...
#include "kernel/rc/tmx/object.hh"
#include "kernel/rc/tmx/wang_set.hh"
#include <iostream>
...
TEST_CASE("Parse a Map from Tiled's documentation")
{
  ...
  REQUIRE(the_map.orientation () == neutrino::kernel::orientation_t::ORTHOGONAL);
  REQUIRE(the_map.render_order () == neutrino::kernel::render_order_t::RIGHT_DOWN);
