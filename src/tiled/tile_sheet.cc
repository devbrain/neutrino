...
namespace neutrino::tiled {
    // --------------------------------------------------------------------------------------------------------------
    tile_sheet::tile_sheet(hal::renderer& renderer, const hal::surface& image, const std::vector<math::rect>& coords)
    : m_pimpl(spimpl::make_unique_impl<detail::tile_sheet_impl>(hal::texture(renderer, image), &coords)) {}
    // --------------------------------------------------------------------------------------------------------------
    tile_sheet::tile_sheet(hal::renderer& renderer, const hal::surface& image)
    : m_pimpl(spimpl::make_unique_impl<detail::tile_sheet_impl>(hal::texture(renderer, image), nullptr)) {}
    // --------------------------------------------------------------------------------------------------------------
