...
namespace formats::iff
{
    ...
    class chunk_type
    {
      friend bool operator == (const chunk_type& a, const chunk_type& b);
      friend bool operator != (const chunk_type& a, const chunk_type& b);
      friend bool operator <  (const chunk_type& a, const chunk_type& b);
      friend bool operator <= (const chunk_type& a, const chunk_type& b);
      friend bool operator >  (const chunk_type& a, const chunk_type& b);
      friend bool operator >= (const chunk_type& a, const chunk_type& b);
    public:
      constexpr explicit chunk_type(const neutrino::utils::string_constant<4>& x)
    ...
    {
        return chunk_type{neutrino::utils::string_factory(value)};
    }
}
