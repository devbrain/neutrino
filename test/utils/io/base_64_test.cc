...
TEST_SUITE("Base64 Encoder")
{
    ...
    {
        {
            ...
            neutrino::utils::io::base64_encoder encoder(str);
    ...
    TEST_CASE("testEncoderURL")
    {
        {
            std::ostringstream str;
            neutrino::utils::io::base64_encoder encoder(str, neutrino::utils::io::BASE64_URL_ENCODING);
            encoder << std::string("\00\01\02\03\04\05", 6);
            encoder.close();
            REQUIRE(str.str() == "AAECAwQF");
        }
    ...
    TEST_CASE("testEncoderNoPadding")
    {
        {
            std::ostringstream str;
            neutrino::utils::io::base64_encoder encoder(str, neutrino::utils::io::BASE64_URL_ENCODING | neutrino::utils::io::BASE64_NO_PADDING);
            encoder << std::string("\00\01\02\03\04\05", 6);
            encoder.close();
            REQUIRE(str.str() == "AAECAwQF");
        }
...
TEST_SUITE("Base64 Decoder")
{
    ...
    {
        {
            ...
            neutrino::utils::io::base64_decoder decoder(istr);
    ...
    TEST_CASE ("testDecoderURL")
    {
        {
            std::istringstream istr("AAECAwQF");
            neutrino::utils::io::base64_decoder decoder(istr, neutrino::utils::io::BASE64_URL_ENCODING);
            REQUIRE_S(decoder.good() && decoder.get() == 0);
            REQUIRE_S(decoder.good() && decoder.get() == 1);
            REQUIRE_S(decoder.good() && decoder.get() == 2);
            REQUIRE_S(decoder.good() && decoder.get() == 3);
    ...
    TEST_CASE ("testDecoderNoPadding")
    {
        {
            std::istringstream istr("AAECAwQF");
            neutrino::utils::io::base64_decoder decoder(istr, neutrino::utils::io::BASE64_NO_PADDING);
            REQUIRE_S(decoder.good() && decoder.get() == 0);
            REQUIRE_S(decoder.good() && decoder.get() == 1);
            REQUIRE_S(decoder.good() && decoder.get() == 2);
            REQUIRE_S(decoder.good() && decoder.get() == 3);
    ...
    {
        {
            ...
            encoder.close();
            neutrino::utils::io::base64_decoder decoder(str);
            std::string s;
            int c = decoder.get();
            while (c != -1)
            {
