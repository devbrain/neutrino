...
TEST_SUITE("zlib") {
  ...
  TEST_CASE_TEMPLATE_INVOKE(test_id1, T0_ZLIB, T0_ZLIB_RAW, T0_GZIP, T0_ZSTD);
  TEST_CASE_TEMPLATE_INVOKE(test_id1, T1_ZLIB, T1_ZLIB_RAW, T1_GZIP, T1_ZSTD);
  TEST_CASE_TEMPLATE_INVOKE(test_id1, T2_ZLIB, T2_ZLIB_RAW, T2_GZIP, T2_ZSTD);

  TEST_CASE_TEMPLATE_INVOKE(test_id2, T0_ZLIB, T0_ZLIB_RAW, T0_GZIP, T0_ZSTD);
  TEST_CASE_TEMPLATE_INVOKE(test_id2, T1_ZLIB, T1_ZLIB_RAW, T1_GZIP, T1_ZSTD);
  TEST_CASE_TEMPLATE_INVOKE(test_id2, T2_ZLIB, T2_ZLIB_RAW, T2_GZIP, T2_ZSTD);

  TEST_CASE_TEMPLATE_INVOKE(test_id3, T0_ZLIB, T0_ZLIB_RAW, T0_GZIP, T0_ZSTD);
  TEST_CASE_TEMPLATE_INVOKE(test_id3, T1_ZLIB, T1_ZLIB_RAW, T1_GZIP, T1_ZSTD);
  TEST_CASE_TEMPLATE_INVOKE(test_id3, T2_ZLIB, T2_ZLIB_RAW, T2_GZIP, T2_ZSTD);

  TEST_CASE_TEMPLATE_INVOKE(test_id4, ZLIB, ZLIB_RAW, GZIP, ZSTD);
  TEST_CASE_TEMPLATE_INVOKE(test_id5, ZLIB, ZLIB_RAW, GZIP, ZSTD);
