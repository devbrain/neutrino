...
#include <neutrino/utils/string_utils.hh>
#include <map>
#include <set>
#include <vector>

using neutrino::utils::trim_left;
using neutrino::utils::trim_left_in_place;
using neutrino::utils::trim_right;
using neutrino::utils::trim_right_in_place;
using neutrino::utils::trim;
using neutrino::utils::trim_in_place;
using neutrino::utils::to_upper;
using neutrino::utils::to_upper_in_place;
using neutrino::utils::to_lower;
using neutrino::utils::to_lower_in_place;
using neutrino::utils::icompare;
using neutrino::utils::istring;
using neutrino::utils::isubstr;
using neutrino::utils::translate;
using neutrino::utils::translate_in_place;
using neutrino::utils::replace;
using neutrino::utils::replace_in_place;
using neutrino::utils::remove;
using neutrino::utils::remove_in_place;
using neutrino::utils::cat;
using neutrino::utils::starts_with;
using neutrino::utils::ends_with;
...
{
    typedef std::map<std::string, int, neutrino::utils::case_insensitive_less_than> CIMapType;
    CIMapType ciMap;
    ...
    typedef std::set<std::string, neutrino::utils::case_insensitive_less_than> CISetType;
