...
void play_game_scene::on_enter() {
    ...
    auto background = rs::build_background(*assets.m_resources, rs::ke_default_fill_block);
    m_world = rs::build_world(assets.m_resources->levels.front(), std::move(background));
