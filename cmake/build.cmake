...
function(my_add_executable EXENAME)
	...
	target_include_directories(${EXENAME} PRIVATE ${PROJECT_INCLUDE} ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_SOURCE_DIR})
	if (PARAMS_FOLDER)
...
macro(my_add_library_static LIBNAME)
	...
	if(MSVC)
		...
		target_compile_options(${_lib} PRIVATE -Wall -Wextra -pedantic -Werror=return-type)
	endif()
