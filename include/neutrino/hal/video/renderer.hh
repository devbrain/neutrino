...
namespace neutrino::hal {
    ...
    public:
        ...
        void copy(const texture& t, const math::rect& srcrect, const math::rect& dstrect, double angle, flip flip_ = flip::NONE);
        void copy(const texture& t, const math::rect& srcrect, const math::rect& dstrect, double angle, const math::point2d& pt, flip flip_);
