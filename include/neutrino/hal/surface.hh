...
#include <neutrino/hal/pixel_format.hh>
...
namespace neutrino::hal {
    ...
    public:
        ...
        void fill (const utils::array_view1d<math::rect>& rects, uint32_t c);
        void fill (const utils::array_view1d<math::rect>& rects, const color& c);
