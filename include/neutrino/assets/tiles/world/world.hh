...
#ifndef INCLUDE_NEUTRINO_ASSETS_TILES_WORLD_WORLD_HH
#define INCLUDE_NEUTRINO_ASSETS_TILES_WORLD_WORLD_HH
...
#include <neutrino/assets/tiles/world/object.hh>
...
namespace neutrino::assets {
  ...
  class world {
    ...
    public:
      ...
      static world from_tmx(std::istream& is, const path_resolver_t& resolver, world_assets& accets);
      static world from_tmx(const std::filesystem::path& path, const path_resolver_t& resolver, world_assets& assets);
    ...
    private:
      static world from_tmx(const tmx::map& map, const path_resolver_t& resolver, world_assets& assets);
    private:
      std::size_t m_width;
      std::size_t m_height;
...
#endif //INCLUDE_NEUTRINO_ASSETS_TILES_WORLD_WORLD_HH
