...
#ifndef NEUTRINO_UTILS_BASE64_HH
#define NEUTRINO_UTILS_BASE64_HH

#include <neutrino/utils/io/unbuffered_stream_buf.hh>
#include <istream>
#include <ostream>
...
namespace neutrino::utils::io {
  ...
  class base64_encoder_buf : public unbuffered_stream_buf
...
#endif //NEUTRINO_UTILS_BASE64_HH
