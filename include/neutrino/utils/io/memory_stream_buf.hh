...
#ifndef NEUTRINO_UTILS_ARCHIVE_MEMORY_STREAM_BUF_HH
#define NEUTRINO_UTILS_ARCHIVE_MEMORY_STREAM_BUF_HH
...
//
    ...
    class  memory_ios : public virtual std::ios
    ...
    class  memory_input_stream : public memory_ios, public std::istream
...
/// Destroys the MemoryInputStream.
    ...
    class  memory_output_stream : public memory_ios, public std::ostream
/// An input stream for reading from a memory area.
    {
    public:
