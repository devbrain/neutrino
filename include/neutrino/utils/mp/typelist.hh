...
namespace neutrino::mp
{
    ...
    namespace detail
    {
        ...
        struct type_list_filter_impl<PREDICATE, RESULT, type_list<X, Ts...>>
        {
            using type = if_then_else_t<PREDICATE<X>::value(),
                    typename type_list_filter_impl<PREDICATE, type_list_append_t<X, RESULT>, type_list<Ts...>>::type,
    ...
    namespace detail
    {
        ...
        struct type_list_map_impl<MAPPER, RESULT, type_list<X, Ts...>>
        {
            using type = typename type_list_map_impl<MAPPER,
                    type_list_append_t<typename MAPPER<X>::type, RESULT>, type_list<Ts...>>::type;
    ...
    namespace detail
    {
        ...
        struct typelist_unique_helper<Result, type_list<V, Rest...>>
        {
            using type = if_then_else_t<type_list_find_first_v<V, Result> == Result::npos,
                    typename typelist_unique_helper<type_list_append_t<V, Result>, type_list<Rest...>>::type,
    ...
    namespace detail
    {
        ...
        {
            static constexpr bool value = detail::Check<std::integral_constant<T, Types2>...>::template contain<std::integral_constant<T, Types1>...>();
        };
    }
