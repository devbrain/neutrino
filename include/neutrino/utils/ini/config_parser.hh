//
// Created by igor on 24/09/2021.
//

#ifndef INCLUDE_NEUTRINO_UTILS_INI_CONFIG_PARSER_HH
#define INCLUDE_NEUTRINO_UTILS_INI_CONFIG_PARSER_HH
...
#include <neutrino/utils/ini/config.hh>
...
namespace neutrino::utils {
  ...
  void config_parser::parse (Config& out, const nlohmann::json& map) {
    ...
    mp::constexpr_for<0, fields_count_val, 1> ([&map, &out] (auto index) {
...
#endif //INCLUDE_NEUTRINO_UTILS_INI_CONFIG_PARSER_HH
