...
namespace neutrino::sdl
{
    ...
    public:
        ...
        std::tuple<pixel_format, unsigned, unsigned> query() const;
...
namespace neutrino::sdl
{
    ...
    // ---------------------------------------------------------------------------------------------------------------
    inline
    std::tuple<pixel_format, unsigned, unsigned> texture::query() const
    {
        uint32_t format;
        int w;
        int h;
        ...
        return {pixel_format(format), static_cast<unsigned>(w), static_cast<unsigned>(h)};
    }
    // ---------------------------------------------------------------------------------------------------------------
    inline
