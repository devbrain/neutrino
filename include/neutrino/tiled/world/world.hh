...
namespace neutrino::tiled {
    ...
    public:
        ...
        [[nodiscard]] bound_sprite_id_t bind_sprite_to_layer(sprite_id_t sprite_id, layer_id_t layer_id, std::size_t current_frame, bool active);
        [[nodiscard]] bound_sprite_id_t bind_sprite_to_layer(sprite_id_t sprite_id, layer_id_t layer_id, std::size_t current_frame);
