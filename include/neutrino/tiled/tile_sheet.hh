...
#ifndef NEUTRINO_TILED_TILE_SHEET_HH
#define NEUTRINO_TILED_TILE_SHEET_HH
...
namespace neutrino
{
    ...
    namespace tiled
    {
        ...
        {
        public:
            tile_sheet(hal::renderer& renderer, const hal::surface& image, const std::vector<math::rect>& coords);
            tile_sheet(hal::renderer& renderer, const hal::surface& image);
            ~tile_sheet();
